...
while (start_date <= end_date):
    ...
    for item in day_flights['Unnamed: 0']:
        ...
        max = tf_data_truncated['headwind_component'].max(skipna=True)
        min = tf_data_truncated['headwind_component'].min(skipna=True)
        ...
        max = tf_data_truncated['temperature_difference'].max(skipna=True)
        min = tf_data_truncated['temperature_difference'].min(skipna=True)
        ...
        average_takeoff_groundspeed = takeoff_data['groundspeed'].mean()
        average_takeoff_climb_rate = takeoff_data['vertical_rate'].mean()

        # Calculate descent-specific features
        descent_data = tf_data_truncated[tf_data_truncated['flight_phase'] == 'Descent']
        average_descent_groundspeed = descent_data['groundspeed'].mean()
        average_descent_climb_rate = descent_data['vertical_rate'].mean()
        ...
        fuel_rate_climb = tf_data_truncated[tf_data_truncated['flight_phase'] == 'Climb']['fuel_burn_rate'].mean()
        fuel_rate_cruise = tf_data_truncated[tf_data_truncated['flight_phase'] == 'Cruise']['fuel_burn_rate'].mean()
        fuel_rate_descent = tf_data_truncated[tf_data_truncated['flight_phase'] == 'Descent']['fuel_burn_rate'].mean()
